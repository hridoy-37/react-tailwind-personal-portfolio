...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "mostafaryhanhridoy@gmail.com",
    href: "mailto:mostafaryhanhridoy@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 max-w-5xl mx-auto">
            ...
            <form className="space-y-5 md:space-y-6" onSubmit={handleSubmit}>
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 md:py-3 bg-surface rounded-lg md:rounded-xl border border-border focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all text-sm md:text-base"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2.5 md:py-3 bg-surface rounded-lg md:rounded-xl border border-border focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all resize-none text-sm md:text-base"
                />
              </div>
              ...
              {submitStatus.type && (
                <div
                  className={`flex items-center gap-2 md:gap-3 p-3 md:p-4 rounded-lg md:rounded-xl ${submitStatus.type === "success"
          ...
          <div className="space-y-6 animate-fade-in animation-delay-400">
              ...
              <div className="space-y-3 md:space-y-4">
                {contactInfo.map((item, i) => (
                  <a
                    key={i}
                    href={item.href}
                    className="flex items-start gap-3 md:gap-4 p-3 md:p-4 rounded-xl hover:bg-surface transition-colors group"
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="font-medium text-sm md:text-base break-words overflow-wrap-anywhere">
                        {item.value}
                      </div>
                    </div>
                  </a>
            ...
            {/* Availability Card */}
            <div className="glass rounded-2xl md:rounded-3xl p-6 md:p-8 border border-primary/30">
              ...
              <p className="text-muted-foreground text-xs md:text-sm">
                I’m open to new opportunities and exciting projects, onsite or remote.
                Whether it’s a full-time role or freelance work, feel free to reach out—let’s talk!
              </p>
            </div>
          </div>
        </div>
